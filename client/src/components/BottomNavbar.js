                            ...
                            <Grid container>
                                ...
                                <Grid item>
                                    <Tabs indicatorColor='secondary' value={value} onChange={(e, val) => setValue(val)}>
                                        ...
                                        <Tab LinkComponent={Link} to='/view-applicants/64e0f80e65e43e42efa960a4/:${id}' icon={<WorkOutlineIcon fontSize='16px' />} iconPosition='top' label='Applied Jobs' sx={{ color: '#4d39e9', fontWeight: 'bold' }}></Tab>
                                    </Tabs>
                                </Grid>
                            </Grid>
