    ...
    return (
        <>
            <Grid container marginTop={10} justifyContent={'center'}>
                <Grid item sx={{backgroundColor:'#0099ff'}}>
                    <img src='https://cdni.iconscout.com/illustration/premium/thumb/searching-for-job-online-4487043-3738450.png' className='img-fluid' alt='login-img' />
                </Grid>
