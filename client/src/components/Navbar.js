...
const Navbar = () => {
  ...
  return (
    <div>
      <AppBar sx={{ background: '#0099ff', color: 'white',fontWeight:'bold',position:'sticky',top:'0'}}>
        <Toolbar>
          ...
          <Box display="flex" marginLeft='auto'>
            ...
            {isLoggedIn && (
              <>
                <Link to='/create-jobs'><Button sx={{backgroundImage: 'linear-gradient(135deg, #F48617, #EDA83C);',border:0,borderRadius:'3',padding:'5px 10px',color:'white'}}>Post Jobs</Button></Link>
